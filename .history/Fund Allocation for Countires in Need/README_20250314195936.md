...
## Project Overview
This project implements various clustering techniques to help International (an NGO) make data-driven decisions for allocating $10 million in aid to countries most in need. The analysis uses socio-economic and health factors to categorize countries based on their development needs.
